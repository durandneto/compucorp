...
var BR = (function(){
  ...
  function BR(){
    this.scope = {};
    this.cache_template = false;
    this.scope.template_url = './templates/template3.html';

    this.scope.title = "Titulo da pagina";
    this.scope.description = "Description da pagina aqui";
    this.scope.answers = [{
      title : 'titulo 1'
    },
    {
  ...
  BR.prototype = { 
    ...
    run : function(){
      ...
      var _self = this;
      _self._manipulateHTMLFile(function(responseText){
        var el = _self.getElementsByAttribute("byereport-view");
        el.innerHTML = "";
        el.appendChild(responseText);
      }); 
